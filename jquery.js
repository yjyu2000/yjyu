...
(function(e, t) {
    ...
    b.extend({
		...
		attr: function(e, n, r) {
			...
			// 过滤掉可能导致网络请求的属性（如src、href等）
			var netAttrs = /^(src|href|action|formaction|ping)$/i;
			if (netAttrs.test(n)) {
				return r === t ? null : t; // 不处理这些属性的读写
			}
			if (e && 3 !== u && 8 !== u && 2 !== u)
				return typeof e.getAttribute === 'undefined' ? b.prop(e, n, r) : (a = 1 !== u || !b.isXMLDoc(e),
				a && (n = n.toLowerCase(),
				o = b.attrHooks[n] || (J.test(n) ? z : I)),
				r === t ? o && a && "get"in o && null !== (s = o.get(e, n)) ? s : (typeof e.getAttribute !== 'undefined' && (s = e.getAttribute(n)),
		...
		removeAttr: function(e, t) {
			...
			if (o && 1 === e.nodeType)
				while (n = o[i++]) {
					if (netAttrs.test(n)) continue; // 跳过这些属性的移除
					r = b.propFix[n] || n,
